...
let downloadLocation = './exportdata/ProcessorsExchangeHistory.xlsx'
let expectedHeaders = './exportdata/Expected_ProcessorsExchangeHistory.xlsx'
let actual, expected
let filterDate = {
...
test.describe('Export tests', () => {
  test('Dashboard - Processors Exchange History Excel', async ({context, page, viewport}) => {
    ...
    await test.step('Click export link', async () => {
      // export link not working sometimes.
